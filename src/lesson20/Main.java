...
public class Main {
    public static void main(String[] args) { //Создание, запись и до запись и просто чтение.
        try {
            RandomAccessFile rf = new RandomAccessFile("rtest.dat", "rw"); // rw - read and write
